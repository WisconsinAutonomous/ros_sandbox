...
: ${AMENT_CURRENT_PREFIX:="/home/ros_sandbox/ros_sandbox/workspace/src/install/image_spawner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/image_spawner/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/image_spawner/environment/path.sh"
